...
public class LoginPage {
	...
	@FindBy(id= "user-name" )  WebElement eleUserNameField;
	@FindBy(id ="password")    WebElement elePasswordField;	
	public LoginPage validLoginCredentials(String userName, String password){
	...
	@FindBy(id ="login-button") WebElement eleLoginButton;
